<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="OppType.aspx.cs" Inherits="SalesManagementSystem.OppType" %>
    ...
    <center>
         ...
         <div class="input-group">
                <div class="form-inline">  
                     <table border="0" cellpadding="5" cellspacing="5" class="table bg-success table-responsive ">
                         ...
                         <tr>
                             <td>
                                <asp:TextBox runat="server" ID="txtOpportunity" placeholder="Opportunity Type" required CssClass="form-control" />
                             </td>
                              <td>
                                <asp:Button Text="Add Type" runat="server" ID="btnAdd" CssClass="btn btn-sm btn-primary" OnClick="btnAdd_Click"  />
                            </td>
        ...
        <asp:GridView ID="GridView1" runat="server"
            CssClass="table table-responsive table-striped" AutoGenerateColumns="False" 
                DataKeyNames="OppId" DataSourceID="LibraryDb"><%--DataSourceID="LibraryDb"--%>
            <Columns>
        ...
        <asp:SqlDataSource ID="LibraryDb" runat="server" ConnectionString="<%$ ConnectionStrings:SalesConnectionString %>" 
            ...
            UpdateCommand="UPDATE [OppType_Table] SET [Name] = @Name  WHERE [OppId] = @OppId">
             <DeleteParameters>
                ...
                <UpdateParameters>
                    <asp:Parameter Name="OppId" Type="String" />
                    <asp:Parameter Name="Name" Type="String" />
                </UpdateParameters>
        </asp:SqlDataSource>
    </center>
